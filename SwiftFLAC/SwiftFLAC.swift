import SwiftFLAC.flac_Private

public class SwiftFLAC {
    ...
    public init(filename: String) throws {
        ...
        guard FLAC__metadata_simple_iterator_init(iterator, filename, FLAC__true, FLAC__true) == FLAC__true else {
            ...
            throw Errors(code: status)
        }

        parseMetaData(iterator)
    }

    func parseMetaData(_ iterator: OpaquePointer?) {
        repeat {
    ...
    func parseVorbisComment(_ block: FLAC__StreamMetadata) {
